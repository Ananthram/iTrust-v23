...
public class MedicalReportFilter extends ReportFilter {
	...
	public enum MedicalReportFilterType {
		PROCEDURE("PROCEDURE"),
		ALLERGY("ALLERGY"),
		CURRENT_PRESCRIPTIONS("sNF2xIsbTwgvSno6Gk0y1"),
		PASTCURRENT_PRESCRIPTIONS("NB0pW_fnz_NY936Q6uZUr57rB7yYPY"),
		DIAGNOSIS_ICD_CODE("DIAGNOSIS"),
		MISSING_DIAGNOSIS_ICD_CODE("MISSING DIAGNOSIS"),
		LOWER_OFFICE_VISIT_DATE("wshsnEGv3OXFCGK5Q0Z2FQLUPJblK"),
