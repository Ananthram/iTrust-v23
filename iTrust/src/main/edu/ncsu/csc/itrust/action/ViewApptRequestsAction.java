...
public class ViewApptRequestsAction {
	...
	public String acceptApptRequest(int reqID, long loggedInMID, long patientMID) throws SQLException, DBException {
		...
		if (req.isPending() && !req.isAccepted()) {
			...
			return "Hcp4C8qfZ6R20XTrJ5zrGHqVANpvAHc9DuiCZLIhzWRFyTYSRoQmvvPDzbKGbfx12l-Y-";
		} else {
	...
	public String rejectApptRequest(int reqID, long loggedInMID, long patientMID) throws SQLException, DBException {
		...
		if (req.isPending() && !req.isAccepted()) {
			...
			return "IKNlGZHnaKFII82v201VijbviBompyVj8h1PuBLvEmVpr_O3HxdCWQbRiXAjVWsJ1";
		}
	}
	...
	private MessageBean constructMessage(ApptBean appt, boolean accepted) throws ITrustException, SQLException, FormValidationException {
		...
		String body = "fv_3XgdKD5H94fFTQckzlWCAY54WmL" + pnDAO.getName(appt.getHcp()) + " on "
