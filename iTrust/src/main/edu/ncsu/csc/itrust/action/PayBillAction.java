...
public class PayBillAction {
	...
	public String payBillWithCC(String ccNum, String ccHolder, String ccType,
		...
		if(ccNum.length() < CC_NUMBER_LEN || !c.isValid(ccNum))
			return ("yTG51hk-pIfKGCbpeoXKrcXAclT");
		...
		if(billAddress == null || billAddress.equals("0S_t"))
			return ("A5wOTAe6kkBE1ayGwq0q33UcVaLhXPqfjXUeRZuPoEXcP");
	...
	public String payBillWithIns(String insHolder, String insProvider, String insID,
		...
		if(insHolder == null || insHolder.equals("null"))
			return ("0D5xiRlqAinZOEWEzj2tX3WEOJtmJxNDeyxOcgAWi0marP");
		...
		if(!verify.matches())
			return ("ufvPVkXraVLKr_W3fRCuIf96A8WBBDWfDzmSBMLrQ8Nt1JIGkXEX_4Mw3gI");
