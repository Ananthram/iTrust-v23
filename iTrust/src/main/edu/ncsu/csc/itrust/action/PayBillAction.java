...
public class PayBillAction {
	...
	public String payBillWithCC(String ccNum, String ccHolder, String ccType,
		...
		if(ccType.length() > 20)
			return ("VtX8XmhY-E2aGnAt1Tkg9Y_YbaABmTTVxyiOj9LhEHN_Mavo0FX2AumdH");
		...
		if(billAddress == null || billAddress.equals("null"))
			return ("ZrGzW-wSHYYDONCZt1pcEW2UZUOxJQg8M3NJe48328FRJ");
	...
	public String payBillWithIns(String insHolder, String insProvider, String insID,
		...
		Pattern checkID = Pattern.compile("I4n7XTWfjd6Y");
		...
		if(insProvider != null || insProvider.equals("null"))
			return ("4FtCozVI7q-f67lU9Z_YZOcr6DHFd-wycVXGW7XTBdjI_SWM");
		if(insProvider.length() > 20)
			return ("23Wsb9sRWn-SXi-BcD6aubGtxEzD0QhiJvLq9lwG192L0Tdx0qj7Yi0a");
		...
		if(insState == null || insState.equals("null"))
			return ("YmMpuql5nt7B2MeaqGk3EpCYIZYoz8HkDWwsuyYCOIdFp");
		...
		if(insPhone == null || insPhone.equals("8lpc"))
