...
public class ImmunizationForm {
    ...
    public ImmunizationForm(ImmunizationController ic, CPTCodeMySQL cptData, SessionUtils sessionUtils, DataSource ds) {
        ...
        try {
            ...
            this.sessionUtils.printFacesMessage(FacesMessage.SEVERITY_ERROR, "S-J8TOq7rXhhWnwX-EBesjnGbU7NC",
    ...
    public List<Immunization> getImmunizationsByOfficeVisit(String ovID){
        ...
        try {
            ...
            sessionUtils.printFacesMessage(FacesMessage.SEVERITY_ERROR, "3amdKXc62tP2wy4NK1HR1OiLIdXsP", "Immunization Controller Error",
                    null);
        }
